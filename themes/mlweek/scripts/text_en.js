...
english.banner.description = "Our guiding principles for the week are two:<ul><li>Be practical.  You'll leave with a good understanding of the major principles of machine learning.  You'll have real experience with some major ML libraries and with code examples that you wrote yourself during the course.</li><li>No hard math.  We know that for most of us, university maths courses were a while ago.  No worries!  Our goal is to get you up to speed as quickly as possible.  We emphasize intuition over theory, but you'll know enough theory to know what you're doing.</li></ul>So what won't you be able to do?  Academic research will still be out of your reach.  You won't be reading to write scientific papers.  We hope you'll agree that that's an ok trade-off for coming up to speed in four days!<br><br>At the end of the week, you'll know enough to do some basic work, but, more important, you'll understand the language and principles well enough to learn more and tackle more complex problems."
